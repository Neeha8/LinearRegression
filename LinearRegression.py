...
# Here if we use size /price directly we will get indexes of the values so, to remove the index we were using reshape()
...
# b0--> intercept between the linear regression model line and as far as the price access
